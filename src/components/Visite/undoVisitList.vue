    ...
    <div class="dataWrapper">
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          ...
          >
          <v-btn icon color="mainBlueColor" v-if="item.type_visite == 'VISITE_PLANIFIEE'" @click="editItem(item)"
            ><v-icon small> mdi-lead-pencil </v-icon></v-btn
          >
          <!-- <v-btn icon color="mainBlueColor" v-if="((item.type_visite == 'VISITE_NON_PLANIFIEE_EMPLOYERS') && (item.etat_visite == 'EN_COURS'))" @click="reportItem(item)"
            ><v-icon small> mdi-redo-variant </v-icon></v-btn
          > -->
          <v-btn icon color="mainBlueColor" @click="reportItem(item)"
            ><v-icon small> mdi-redo-variant </v-icon></v-btn
          >
          <!-- <v-btn icon color="mainBlueColor"  v-if="((item.type_visite != 'VISITE_PLANIFIEE') && (item.etat_visite == 'EN_COURS'))" @click="acceptItem(item)"
